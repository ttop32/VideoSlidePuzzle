...
const IonModal = /*@__PURE__*/ defineOverlayContainer('ion-modal', ionModal_js.defineCustomElement, ['animated', 'backdropBreakpoint', 'backdropDismiss', 'breakpoints', 'enterAnimation', 'handle', 'htmlAttributes', 'initialBreakpoint', 'isOpen', 'keyboardClose', 'leaveAnimation', 'mode', 'presentingElement', 'showBackdrop', 'swipeToClose', 'trigger']);
...
const modalController = /*@__PURE__*/ createController('ion-modal', ionModal_js.IonModal, components.modalController, true);
const popoverController = /*@__PURE__*/ createController('ion-popover', ionPopover_js.IonPopover, components.popoverController, true);
const alertController = /*@__PURE__*/ createController('ion-alert', ionAlert_js.IonAlert, components.alertController);
const actionSheetController = /*@__PURE__*/ createController('ion-action-sheet', ionActionSheet_js.IonActionSheet, components.actionSheetController);
const loadingController = /*@__PURE__*/ createController('ion-loading', ionLoading_js.IonLoading, components.loadingController);
const pickerController = /*@__PURE__*/ createController('ion-picker', ionPicker_js.IonPicker, components.pickerController);
const toastController = /*@__PURE__*/ createController('ion-toast', ionToast_js.IonToast, components.toastController);
